...
def build_arg_parser():
    ...
    parser.add_argument('--classifier-type',
                        ...
                        required=True,
                        choices=['rf', 'erf'],
                        help="Type of \ classifier to use; can be either 'rf' of 'erf'")
    return parser
...
if __name__ == '__main__':
    ...
    plt.scatter(class_0[:, 0], class_1[:, 1], s=75, facecolors='white', edgecolors='black', linewidth=1, marker='o')
    plt.scatter(class_0[:, 0], class_2[:, 1], s=75, facecolors='white', edgecolors='black', linewidth=1, marker='^')
